...
const Header = () => {
  ...
  const profilePicture = useSelector((state: RootState) => state.recruiterAuth.recruiter?.profilePicture)
  ...
  const dropdownProfileItems = [
    { label: 'Subscription', href: '/recruiter/premium' },
          ...
          <div className="flex items-center space-x-8">
            ...
            <div className="hidden md:flex space-x-9 pl-14 pt- relative">
              ...
              >
                <Link
                  href="/recruiter/jobs"
                  className="text-md font-medium focus:outline-none pb-2"
                >
                  Jobs
                </Link>
                <DropdownMenu
              ...
              <>
                ...
                >
                  <button onClick={toggleSidebar}>
                    <Image
                      src={
                        profilePicture || "https://i.pinimg.com/564x/47/09/80/470980b112a44064cd88290ac0edf6a6.jpg"
                      }
                      alt="Profile"
                      width={32}
                      height={32}
